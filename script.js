    ...
    data.items.forEach(item => {
        ...
        galleryItem.innerHTML = `
            <div class=\"gallery-placeholder\">
                ${item.image ? `<img src=\"${item.image}\" alt=\"${item.title}\" style=\"width: 100%; height: 100%; object-fit: cover; border-radius: 8px;\">` : `<i class=\"fas fa-image\" style=\"font-size: 2rem; color: #666;\"></i>`}
            </div>
